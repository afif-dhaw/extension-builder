...
return [
    'packages' => [
        ...
        'formation' => [
            'packagePath' => 'typo3conf/ext/formation/',
        ],
        'bw_captcha' => [
            'packagePath' => 'typo3conf/ext/bw_captcha/',
        ],
        'extension_builder' => [
            'packagePath' => 'typo3conf/ext/extension_builder/',
        ],
        'filter' => [
            'packagePath' => 'typo3conf/ext/filter/',
        ],
        'formation_fsc' => [
            'packagePath' => 'typo3conf/ext/formation_fsc/',
        ],
        'news' => [
            'packagePath' => 'typo3conf/ext/news/',
        ],
        'oauth2_client' => [
            'packagePath' => 'typo3conf/ext/oauth2_client/',
        ],
    ],
    'version' => 5,
]; -->
